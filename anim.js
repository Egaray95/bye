...
var lyricsData = [
  ...
  { text: "Y así mi amor te conocí", time: 29 },
  { text: "Poco a poco comencé a sentir", time: 34 },
  { text: "Que tu mirada comenzó a cambiar", time: 39 },
  { text: "Dos corazones listos para comenzar a amar", time: 43 },
  { text: "Y abriste tus puertas", time: 49 },
  { text: "Dejándome entrar", time: 52 },
  { text: "Tu mundo me curó tristezas", time: 56 },
  { text: "Tu risa me trajo de vuelta el alma", time: 61 },
  { text: "Y amar es poco decir a lo que siento", time: 67 },
  { text: "Cuando yo estoy junto a ti", time: 73 },
  { text: "Ahora puedo despertarme", time: 79 },
  { text: "Y dejar que el sol me diga que soy libre", time: 83 },
  { text: "Gracias a ti", time: 89 },
  { text: "Yo puedo decir que he vuelto a nacer", time: 92 },
  { text: "Gracias a ti", time: 97 },
  { text: "En el destino he vuelto a creer", time: 103 },
  { text: "Quiero quedarme", time: 109 },
